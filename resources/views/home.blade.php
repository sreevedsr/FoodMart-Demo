          ...
          <div class="category-carousel swiper">
            <div class="swiper-wrapper">
              @foreach($categories as $category)
                <a href="{{ route('category.products', $category->id) }}" class="nav-link category-item swiper-slide">
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="card mb-3 p-3 rounded-4 shadow border-0">
                  <div class="row g-0">
                    <div class="col-md-4">
                      <img src=" {{ asset('assets/images/product-thumb-11.jpg')  }}" class="img-fluid rounded"
                        alt="Card title">
                    </div>
                    <div class="col-md-8">
              ...
              <div class="swiper-slide">
                <div class="card mb-3 p-3 rounded-4 shadow border-0">
                  <div class="row g-0">
                    <div class="col-md-4">
                      <img src=" {{ asset('assets/images/product-thumb-12.jpg')  }}" class="img-fluid rounded"
                        alt="Card title">
                    </div>
                    <div class="col-md-8">
                      <div class="card-body py-0">
              ...
              <div class="swiper-slide">
                <div class="card mb-3 p-3 rounded-4 shadow border-0">
                  <div class="row g-0">
                    <div class="col-md-4">
                      <img src=" {{ asset('assets/images/product-thumb-13.jpg')  }}" class="img-fluid rounded"
                        alt="Card title">
                    </div>
                    <div class="col-md-8">
                      <div class="card-body py-0">
              ...
              <div class="swiper-slide">
                <div class="card mb-3 p-3 rounded-4 shadow border-0">
                  <div class="row g-0">
                    <div class="col-md-4">
                      <img src=" {{ asset('assets/images/product-thumb-14.jpg')  }}" class="img-fluid rounded"
                        alt="Card title">
                    </div>
                    <div class="col-md-8">
                      <div class="card-body py-0">
                      ...
                      <div class="product-item">
                        ...
                        @auth
                          <form action="{{ route('wishlist.store', $product->id) }}" method="POST">
                            @csrf
                            <button type="submit"
                              class="btn-wishlist {{ Auth::user()->wishlist->contains('product_id', $product->id) ? 'active' : '' }}"
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                          ...
                          <a href="#" class="nav-link btn btn-primary px-4 py-2 add-to-cart"
              ...
              @foreach($products as $product)
                <div class="product-item swiper-slide">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="#" class="nav-link btn btn-primary px-4 py-2 add-to-cart" data-product="{{ $product->id }}">
                      Add to Cart <iconify-icon icon="uil:shopping-cart"></iconify-icon>
                    </a>
                  </div>
                </div>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sagittis sed ptibus liberolectus nonet psryroin.
                ...
                Amet blandit tortor praesent ante vitae. A, enim pretiummi senectus magna. Sagittis sed ptibus
                liberolectus non et psryroin.</p>
