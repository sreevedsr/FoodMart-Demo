    ...
    <div class="row py-3 border-bottom">
      ...
      <div
        ...
        <ul class="d-flex justify-content-end list-unstyled m-0">
          <li>
            <a href="{{ $onDashboard ? url('/') : route('dashboard') }}"
              title="{{ $onDashboard ? 'Home' : 'Dashboard' }}" class="rounded-circle bg-light p-2 mx-1">
              <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="{{ $onDashboard ? '#home-icon' : '#user-icon' }}"></use>
              </svg>
            </a>
          </li>
          <li>
